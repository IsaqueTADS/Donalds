      ...
      {orders.map((order) => (
        <Card key={order.id}>
          ...
          <CardContent className="p-5 space-y-6">
            ...
            <div className={`w-fit px-2 py-1 text-xs font-se  rounded-full
            ...
            <div className="flex itemns-center gap-2">
              <div className="relative h-5 w-5">
                <Image src={order.restaurant.avatarImageUrl} alt={order.restaurant.name} className="rounded-full" fill />
              </div>
